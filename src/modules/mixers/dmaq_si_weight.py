...
class DMAQ_SI_Weight(nn.Module):
    ...
    def forward(self, states, actions):
        ...
        all_head_key = [k_ext(states) for k_ext in self.key_extractors] # [num_kernel, (bs, 1)]
        all_head_agents = [k_ext(states) for k_ext in self.agents_extractors] # [num_kernel, (bs, n_agents)]
        all_head_action = [sel_ext(data) for sel_ext in self.action_extractors] # [num_kernel, (bs, n_agents)]
        ...
        for curr_head_key, curr_head_agents, curr_head_action in zip(all_head_key, all_head_agents, all_head_action):
            ...
            head_attend_weights.append(weights) # [num_kernel, (bs, n_agents))]
